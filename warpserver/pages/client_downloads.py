...
client_downloads_page_blueprint = Blueprint(
    "client_download", __name__, template_folder="templates"
)
...
def downloads_page():
    return render_template(
        ...
        latest_release=get_latest_client_release_information_from_github(),
        releases=get_client_release_informations_from_github(),
    )
